...
import { BiImage, IoIosCheckboxOutline, AiOutlineBulb ,IoColorPaletteOutline, RiInboxArchiveLine,BsThreeDotsVertical,BsPin} from "react-icons/all";
export const Notes = () => {
        ...
        <div className="NotesInput">
          ...
          />
                  ...
                  <div className="note-popup">
                    ...
                    <input type="text" id="noteText" className="note" placeholder="Take a note"
                    value={note}
                    onChange={handleInputChange} />
